...
const stats = ref([
  { label: 'Total Volume', value: '$0', target: '6309', prefix: '$', suffix: '' },
  { label: 'Active Users', value: '0', target: '36', prefix: '', suffix: '+' },
  { label: 'Transactions', value: '0', target: '283', prefix: '', suffix: '' },
])
      ...
      <section id="roadmap" class="py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
          <div class="glass-card p-12 cosmic-glow text-center">
            ...
            <a href="/roadmap" class="inline-flex items-center gap-2 text-cosmic-400 hover:text-cosmic-300 transition font-semibold">
              View Full Roadmap
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
