...
<template>
  <div class="relative min-h-screen overflow-hidden">
    ...
    <!-- Main Content -->
    <div class="relative z-10 mx-auto flex h-[100dvh] max-w-6xl flex-col p-2 sm:p-4">
      <header class="mb-2 sm:mb-4 shrink-0 glass-card">
        <!-- Primary row: Logo + Desktop Tabs + Actions -->
        <div class="flex items-center justify-between p-3 sm:p-4">
          <a
            href="/"
            class="flex items-center gap-2 sm:gap-3 group no-underline shrink-0"
            title="Return to home"
          >
            <svg width="32" height="32" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 sm:h-8 sm:w-8 transition-transform group-hover:scale-105">
            ...
            <div class="relative">
              <h1 class="text-lg sm:text-xl font-semibold gradient-text group-hover:opacity-80 transition">Esprito AI</h1>
