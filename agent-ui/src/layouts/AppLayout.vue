    ...
    <div class="relative z-10 mx-auto flex h-screen max-w-6xl flex-col p-4">
      <header class="mb-4 flex shrink-0 items-center justify-between glass-card p-4">
        <div class="flex items-center gap-4">
          ...
          <a
            href="/"
            class="flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/10 transition border border-gray-300 dark:border-white/20 no-underline"
