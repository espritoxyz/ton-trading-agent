        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center h-20">
            ...
            <div class="flex items-center gap-6">
              ...
              <a href="http://localhost:5173" target="_blank" class="px-6 py-2 bg-gradient-to-r from-cosmic-500 to-purple-600 rounded-full hover:opacity-90 transition font-semibold">
                Launch App
              </a>
            </div>
          </div>
