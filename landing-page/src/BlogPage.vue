...
const blogPosts = ref([
  {
    id: 1,
    title: 'Introducing Esprito AI: The Future of DEX Trading',
    excerpt: 'We are excited to announce the launch of Esprito AI, a revolutionary AI-powered trading assistant for the TON ecosystem.',
    category: 'company',
  ...
  },
  {
    ...
    excerpt: 'Deep dive into the natural language processing technology that powers Esprito AI conversational trading experience.',
  ...
  },
  {
    ...
    excerpt: 'An overview of our security architecture and why your funds are always safe with Esprito AI non-custodial approach.',
    category: 'engineering',
